...
type Service interface {
	...
	Create(ctx context.Context, eventID string, ticket Ticket) error
	Delete(ctx context.Context, eventID, ticketName string) error
	GetByName(ctx context.Context, eventID, ticketName string) (Ticket, error)
	Get(ctx context.Context, eventID string) ([]Ticket, error)
	Refund(ctx context.Context, session auth.Session, eventID, ticketName string) error
	Update(ctx context.Context, eventID, ticketName string, updateTicket UpdateTicket) error
}
...
func (s service) Buy(ctx context.Context, session auth.Session, eventID, ticketName string, userIDs []string) error {
	...
	return s.roleService.SetRole(ctx, eventID, role.SetRole{RoleName: linkedRole, UserIDs: userIDs})
}
...
func (s service) GetByName(ctx context.Context, eventID, ticketName string) (Ticket, error) {
...
func (s service) Get(ctx context.Context, eventID string) ([]Ticket, error) {
	q := "SELECT available_count, name, description, cost, linked_role FROM events_tickets WHERE event_id=$1"
